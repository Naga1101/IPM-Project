	...
	export default {
		...
		methods: {
			async finishService() {
				...
				const result = await DBRequests.postFinishedService(recommendedServicesId,this.notas,this.currentService.veiculo.id,this.currentService.id, dataConclusao)
